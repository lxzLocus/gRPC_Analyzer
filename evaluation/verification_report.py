...
def generate_verification_report():
    ...
    print("2. OpenAIモデル選択機能（gpt-4o, gpt-4o-mini, gpt-4-turbo等）")
    ...
    verification_results = [
        ...
        },
        {
            "機能": "OpenAIモデル選択",
            "結果": "✅ 成功",
            "詳細": "gpt-4o, gpt-4o-mini等の複数モデル対応、推奨モデル警告機能動作"
        },
        {
            "機能": "メトリクス計算",
            "結果": "✅ 成功",
    ...
    print()
    print("2. OpenAIモデル選択:")
    print("   SystemComplianceEvaluator(llm_provider='openai', llm_model='gpt-4o-mini')")
    print()
    print("3. 全プロジェクト評価:")
