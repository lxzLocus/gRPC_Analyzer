#!/usr/bin/env python3
"""
データセット全件LLM評価実行ツール - gpt-4.1使用
最新gpt-4.1モデルを使用した全421ログの大規模評価
"""
...
class FullDatasetEvaluator:
    ...
    def __init__(self, llm_model: str = "gpt-4.1", concurrent_limit: int = 5):
...
async def main():
    ...
    parser.add_argument("--model", "-m", default="gpt-4.1", help="使用するLLMモデル")
