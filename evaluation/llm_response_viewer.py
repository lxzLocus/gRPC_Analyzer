...
async def show_llm_response_details():
    ...
    providers_info = [
        ...
        # ("OpenAI GPT-4", OpenAIProvider("gpt-4o")),
    ...
    print("   python evaluation_log_viewer.py --latest")
    print("   python evaluation_log_viewer.py --repo servantes")
    print("   python evaluation_log_viewer.py -f [ファイル名]")
