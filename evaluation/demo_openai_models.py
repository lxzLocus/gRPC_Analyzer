    ...
    examples = [
        {
            ...
            "code": 'evaluator = SystemComplianceEvaluator(llm_provider="openai", llm_model="gpt-4o")',
            "description": "最新かつ最高性能のモデル。重要な評価に最適"
        },
        {
            "scenario": "コスト効率を重視した開発環境",
            "code": 'evaluator = SystemComplianceEvaluator(llm_provider="openai", llm_model="gpt-4o-mini")',
        ...
        },
        {
            ...
            "description": "モデル未指定時はgpt-4oが自動選択される"
        },
        {
