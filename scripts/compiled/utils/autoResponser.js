...
async function main() {
    ...
    let next_prompt_content = fileManager.readFirstPromptFile();
    let prompt_template_name = config.promptTextfile;
    ...
    logger.setExperimentMetadata(experimentId, startTime, endTime, status, turn_count, totalPromptTokens, totalCompletionTokens);
